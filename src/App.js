...
import ComicHome from "./components/admin/ComicHome";
import ComicUpload from "./components/product/comic.component";
    ...
    <React.Fragment>
      <ThemeProvider theme={themeMode}>
        ...
        <Switch>
          ...
          <Route exact path="/comichome">
            <Protected Cmp={ComicHome} />
          </Route>

          <Route exact path="/comicupload">
            <Protected Cmp={ComicUpload} />
          </Route>
